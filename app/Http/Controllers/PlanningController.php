...
class PlanningController extends Controller
{
    ...
    public function ajouter(Request $req)
    {
        ...
        if ($req->acces < 3 && $serverId != Auth::id()) return response("Inscription impossible pour un autre compte que le sien", 403);
        ...
        if ($job > 4 || $job < 0 || $noAccount) return response("Valeurs données invalides", 400);
