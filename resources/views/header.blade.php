        ...
        <span id="cote-droit" class="flex items-center justify-between">
            ...
            <nav id="menu" class="overflow-hidden h-0 transition-all text-lg duration-500 ease-in-out flex flex-col items-center bg-white absolute w-full left-0 top-full md:static md:flex-row md:items-stretch md:justify-start md:h-auto md:overflow-visible">
                @can('verifier-acces-serveur')
                    <a href="/admin/panneau-admin" class="w-full text-center px-8 py-4 hover:bg-gray-100 text-black">Admin</a>
                @endcan
                ...
                <div class="relative w-full">
                    ...
                    <div id="compte-dropdown" class="overflow-hidden max-h-0 text-base text-center md:text-left transition-all duration-500 bg-white w-full absolute left-0 z-10">
                        @auth
                        ...
                        @guest
                                <a href="/connexion" class="block px-4 py-2 hover:bg-gray-100 text-black">Connexion</a>
                                <a href="/inscription" class="block px-4 py-2 hover:bg-gray-100 text-black">Inscription</a>
                        @endguest
                    </div>
                </div>
            </nav>
