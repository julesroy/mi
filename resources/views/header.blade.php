<header class="fixed top-0 left-0 w-full bg-white shadow z-50">
    <div class="flex items-center justify-between px-4 py-8 md:py-6">
        <span class="text-2xl font-bold text-black">Par'MI'Giano</span>
    ...
    <nav id="menu" class="overflow-hidden h-0 transition-all duration-500 ease-in-out flex flex-col items-center bg-white absolute w-full left-0 top-full shadow md:static md:flex-row md:items-stretch md:justify-start md:h-auto md:overflow-visible">
        ...
        <div class="relative w-full">
            ...
            <div id="compte-dropdown" class="overflow-hidden max-h-0 transition-all duration-500 bg-white shadow w-full absolute left-0 z-10">
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 text-black">Profil</a>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 text-black">Déconnexion</a>
            </div>
        </div>
    </nav>
...
compteBtn.addEventListener('click', (e) => {
    ...
    compteArrow.classList.toggle('rotate-180', dropdownOpen); // Ajoute cette ligne
});
...
document.addEventListener('click', () => {
    if (dropdownOpen) {
        ...
        compteArrow.classList.remove('rotate-180'); // Ajoute cette ligne
    }
});
