...
<body class="bg-[#0a0a0a] text-white pt-28 md:pt-36">
    ...
    <dialog id="inscriptionDialog"
        class="backdrop-brightness-50 backdrop-blur-xs flex items-center justify-center w-full bg-transparent h-full absolute top-0 d not-open:hidden">
        <form method="POST" action="planning/ajouter-inscription"
            ...
            <span class="flex flex-row">
                <button type="button" class="border border-white m-auto cursor-pointer"
                    onclick="document.getElementById('inscriptionDialog').close()">
                    Annuler
                </button>
    ...
    <button class="border-white border cursor-pointer m-1.5 p-1"
        onclick="document.getElementById('inscriptionDialog').show()">
        Inscription
    </button>
