            ...
            <div class="grid grid-cols-4 gap-4 h-[520px]">
                ...
                <div class="flex flex-col h-full">
                    <div class="bg-[#18181b] rounded-2xl shadow-lg p-4 flex flex-col flex-1 mb-2">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="text" placeholder="Rechercher..." class="search-box px-2 py-1 rounded bg-[#232326] text-white placeholder-gray-400 focus:outline-none text-sm" data-box="menus" oninput="filterBox('menus', this.value)" style="width: 110px" />
                        </div>
                        <ul id="list-menus" class="space-y-1 no-scrollbar overflow-y-auto flex-1">
                            @foreach (($carteItems[3] ?? collect())->concat($carteItems[4] ?? collect()) as $item)
                                ...
                                <li class="bento-item p-1 rounded cursor-pointer hover:bg-gray-700 transition-colors text-sm {{ $stock <= 0 ? "disabled-item" : "" }}" data-nom="{{ $item->nom }}" data-prix="{{ $item->prix }}" data-stock="{{ $stock }}" onclick="addToCart(this)">
                                    {{ $item->nom }} - {{ $item->prix }}€
                                    @if ($stock <= 0)
                    ...
                    <div class="bg-[#18181b] rounded-2xl shadow-lg p-4 flex flex-col flex-1 mt-2">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <input type="text" placeholder="Rechercher..." class="search-box px-2 py-1 rounded bg-[#232326] text-white placeholder-gray-400 focus:outline-none text-sm" data-box="plats" oninput="filterBox('plats', this.value)" style="width: 110px" />
                        </div>
                ...
                <div class="bg-[#18181b] rounded-2xl shadow-lg p-4 flex flex-col h-full">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <input type="text" placeholder="Rechercher..." class="search-box px-2 py-1 rounded bg-[#232326] text-white placeholder-gray-400 focus:outline-none text-sm" data-box="snacks" oninput="filterBox('snacks', this.value)" style="width: 110px" />
                    </div>
                ...
                <div class="bg-[#18181b] rounded-2xl shadow-lg p-4 flex flex-col h-full">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <input type="text" placeholder="Rechercher..." class="search-box px-2 py-1 rounded bg-[#232326] text-white placeholder-gray-400 focus:outline-none text-sm" data-box="boissons" oninput="filterBox('boissons', this.value)" style="width: 110px" />
                    </div>
