...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#0a0a0a] text-white pt-28 md:pt-36">
        ...
        <div class="container mx-auto p-4">
            <h1 class="text-2xl font-bold mb-4">Inventaire des stocks</h1>
            ...
            <div class="overflow-x-auto">    
                <p class="mb-2 text-sm text-gray-400">
                    Trié par <span class="font-semibold text-white">
                        @switch($sort)
                            @case('nom') Nom @break
                            @case('categorieElement') Catégorie @break
                            @case('numeroLot') Lot @break
                            @case('datePeremption') Date péremption @break
                            @case('nombrePortions') Portions @break
                            @case('dateOuverture') Ouverture @break
                            @case('dateFermeture') Fermeture @break
                        ...
                        <tr class="bg-gray-700">
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Nom {!! sort_arrow('nom', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Catégorie {!! sort_arrow('categorieElement', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Lot {!! sort_arrow('numeroLot', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Date péremption {!! sort_arrow('datePeremption', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Portions {!! sort_arrow('nombrePortions', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Ouverture {!! sort_arrow('dateOuverture', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    Fermeture {!! sort_arrow('dateFermeture', $sort, $direction) !!}
                                </a>
                            </th>
                            <th class="py-2 px-4 border-b">
                                <a href="{{ request()->fullUrlWithQuery([
                                    ...
                                    État {!! sort_arrow('etat', $sort, $direction) !!}
                                </a>
                            </th>
                        </tr>
                    </thead>
