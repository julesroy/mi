...
<body class="bg-[#0a0a0a] text-white pt-28 md:pt-36">
    ...
    <style>
        .etat-0 { background-color: rgba(192, 57, 43, 0.2); color: #e74c3c; }
        .etat-1 { background-color: rgba(243, 156, 18, 0.2); color: #f39c12; }
        .etat-2 { background-color: rgba(41, 128, 185, 0.2); color: #3498db; }
        .etat-3 { background-color: rgba(39, 174, 96, 0.2); color: #2ecc71; }
        .etat-4 { background-color: rgba(127, 140, 141, 0.2); color: #95a5a6; }
        .commande-card { transition: all 0.3s ease; }
        .commande-card:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.2); }
        .commande-test { border: 2px dashed #f39c12; }
