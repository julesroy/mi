...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
    ...
    <body class="bg-white text-black pt-28 md:pt-60">
        ...
        <dialog id="modifierCommandeDialog" class="bg-[#00000045] z-50 flex justify-center items-center fixed top-0 left-0 w-full h-full not-open:hidden">
            <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <span id="numeroCommandeModifiee" class="font-bold text-xl">N° commande</span>
                        <button onclick="document.getElementById('modifierCommandeDialog').close()" class="text-gray-500 hover:text-gray-700">
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <button onclick="document.getElementById('modifierCommandeDialog').close()" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">Annuler</button>
