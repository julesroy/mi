                    ...
                    @forelse ($actus as $actu)
                        <tr>
                            ...
                            <td class="py-2 px-4 align-middle">
                                @if ($actu->image)
                                    <img src="{{ asset('images/actus/' . $actu->image) }}" alt="Image actu" class="w-20 h-12 object-cover rounded border border-gray-400" />
                                @else
                            ...
                            <td class="py-2 px-4 text-center align-middle">
                                <button
                                    ...
                                    '{{ $actu->image ? asset("images/actus/" . $actu->image) : "" }}',
                                    '{{ $actu->image ? 1 : 0 }}'
                                )"
                                >
                                    Modifier
