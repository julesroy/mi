...
<body class="bg-white text-black pt-28 md:pt-60">
    ...
    <!-- Dialog Température -->
    <dialog id="tempDialog" class="bg-white rounded-[13px] shadow-xl p-6 w-full max-w-md">
        <div class="flex justify-between items-center mb-4">
    ...
    <!-- Dialog Nettoyage -->
    <dialog id="cleanDialog" class="bg-neutral-200 rounded-[13px] shadow-xl p-6 w-full max-w-md">
        <div class="flex justify-between items-center mb-4">
