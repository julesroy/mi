        ...
        <main class="container mx-auto px-4 py-12">
            <section class="mb-12">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button onclick="showDialog('tempDialog')" class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded">+ Nouveau relevé</button>
                </div>
            ...
            <section class="mb-12">
                ...
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold">Historique</h2>
                    <button onclick="showDialog('cleanDialog')" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded">+ Nouveau nettoyage</button>
                </div>
            ...
            <form action="{{ route("admin.salle-securite.ajouter-releve-frigo") }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" step="0.1" name="temperature1" required class="w-full bg-gray-700 border border-gray-600 rounded p-2" />
                    </div>
                    <div>
                        <label class="block mb-2">Température Frigo 2 (°C)</label>
                        <input type="number" step="0.1" name="temperature2" required class="w-full bg-gray-700 border border-gray-600 rounded p-2" />
                    </div>
                    <div class="flex justify-end space-x-3 pt-2">
                        <button type="button" onclick="hideDialog('tempDialog')" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded">Annuler</button>
                        <button type="submit" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded">Enregistrer</button>
                    </div>
                </div>
            </form>
        </dialog>
            ...
            <form action="{{ route("admin.salle-securite.ajouter-nettoyage") }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="commentaire" rows="3" required class="w-full bg-gray-700 border border-gray-600 rounded p-2"></textarea>
                    </div>
                    <div class="flex justify-end space-x-3 pt-2">
                        <button type="button" onclick="hideDialog('cleanDialog')" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded">Annuler</button>
