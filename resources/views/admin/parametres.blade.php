        ...
        <section class="flex flex-col items-center gap-10 bg-[#1a1a1a] p-6 rounded-2xl w-[90%] max-w-4xl mx-auto">
            ...
            <section x-data="options()" class="w-full bg-white rounded-xl shadow p-6">
                ...
                <div class="flex flex-col gap-4 mb-6">
                    <!-- Mode événement -->
                    <button 
                        @click="basculer('modeEvenement')" 
                        :class="modeEvenement ? 'bg-red-800 text-white' : 'bg-gray-200 text-gray-900'"
                        class="w-full py-3 rounded-lg font-semibold text-lg transition">
                        Mode événement
                    </button>

                    <!-- Commandes en ligne -->
                    <button 
                        @click="basculer('commandesEnLigne')" 
                        :class="commandesEnLigne ? 'bg-red-800 text-white' : 'bg-gray-200 text-gray-900'"
                        class="w-full py-3 rounded-lg font-semibold text-lg transition">
                    ...
                    <button 
                        @click="basculer('limitationHeures')" 
                        :class="limitationHeures ? 'bg-red-800 text-white' : 'bg-gray-200 text-gray-900'"
                        class="w-full py-3 rounded-lg font-semibold text-lg transition">
            ...
            <section class="w-full bg-white rounded-xl shadow p-6">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <button class="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold text-lg transition hover:bg-blue-700">
                        Enregistrer le logo
                    </button>
                </div>
            </section>
