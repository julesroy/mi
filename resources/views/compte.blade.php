...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#0a0a0a] text-white pt-28 md:pt-36">
        ...
        <div class="flex place-self-center relative min-h-full flex-col justify-center px-6 py-6"> <!-- div main compte -->

            <div class="flex flex-col border-3 border-y-gray-600 mb-8"> <!-- liste des commandes actuelles -->
            ...
            <div class="flex flex-col border-3 border-y-gray-600"> <!-- Données de compte -->

                <div class="bg-gray-900"> <!-- Titre -->  
            ...
            <div class="flex flex-col justify-center min-h-40 min-w-80"> <!-- Changer mot de passe ? & Déconnexion-->
                ...
                <div > <!-- Déconnexion -->
                    <button class="bg-gray-800 px-5 py-2 hover:bg-gray-400 hover:cursor-pointer mt-1 min-w-full min-h-full">
                        Déconnexion
                    </button>
                </div>
