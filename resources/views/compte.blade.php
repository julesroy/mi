                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                @foreach ($paiements as $paiement)
                                                    ...
                                                    @if ($paiement->commandes)
                                                        <ul class="list-disc pl-4">
                                                            @foreach ($paiement->commandes as $commande)
                                                                <li class="mb-2">
                                                                    <div>
                                                                        <span class="font-semibold">Commande {{ $commande->numeroCommande }} :</span>
                                                                        <span>
                                                                            @php
                                                                                if ($commande->stock) {
                                                                                    foreach (explode(";", $commande->stock) as $item) {
                                                                                        [$idArticle, $quantite, $obligatoire] = explode(
                                                                                            ",",
                                                                                            $item,
                                                                                        );
                                    ...
                                    @if (! $loop->last)
                                        <tr>
                                            <td colspan="4" style="height: 8px; padding: 0; border: none; background: transparent"></td>
                                        </tr>
                                    @endif
                                @endforeach
                            </tbody>
