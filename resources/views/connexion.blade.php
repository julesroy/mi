...
<body class="bg-[#FFFFFF] text-black pt-18 md:pt-40">
    ...
    <dialog id="forgotPasswordDialog"
        class="translate-[-50%] left-[50%] top-[50%] md:w-130 w-90 flex items-center border-5 border-black rounded-[13px] justify-center z-50 invisible transition-opacity duration-300 bg-opacity-50">
    ...
    <dialog id="resetConfirmationDialog"
        class="translate-[-50%] left-[50%] top-[50%] md:w-130 flex items-center border-5 border-black rounded-[13px] justify-center z-50 invisible transition-opacity duration-300 bg-opacity-55">
        <div class="bg-white w-full max-w-md p-6 relative mx- my-auto">
            <button onclick="hideDialog('resetConfirmationDialog')"
                class="absolute top-2 right-0 text-gray-500 hover:text-black focus:outline-none">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
